	...
	EB_S16 searchAreaHeight)
{
	...
	{			
				...
				__m512i x1 = _mm512_setr_epi64(0x0001000100010001, 0x0002000200020002, 0x0005000500050005, 0x0006000600060006, 0x0002000200020002, 0x0003000300030003, 0x0006000600060006, 0x0007000700070007);				if (height <= 16 && searchAreaWidth <= 128)
				{
					for (i = 0; i<searchAreaHeight; i++) 
					{
